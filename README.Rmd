...
* Stratify indicators according to arbitrary age groups, calendar periods, birth cohorts, calendar periods, time before survey, or other survey variables (region, residence, wealth category, educatation, etc.).
...
* Default parameters for analysis of [DHS recode datasets](https://dhsprogram.com/data/) without fuss, but flexible implementation for use with other survey data.
...
years before the survey. Before calculating mortality rates, create variables for 
whether a death occurred and the date of death, placed on average 0.5 months in the 
...
DHS indicator uses a rule-based approach to allocating child deaths and person 
years across age groups and proceeds by calculatind direct probabilities of death 
