...
For analysis of DHS data, the package interacts well with [`rdhs`](https://ojwatson.github.io/rdhs/). See the [vignette](https://github.com/mrc-ide/hhsurveydata/blob/master/vignettes/rdhs-integration.pdf) for an example.
