...
Identify all DHS surveys conducted in sub-Saharan Africa between 2015 and 2020

```{r dhs_surveys}
countries <- dhs_countries()
cc <- countries[RegionName == "Sub-Saharan Africa"]$DHS_CountryCode
surveys <- dhs_surveys(countryIds = cc, surveyYearStart=2015, surveyYearEnd = 2020, surveyType = "DHS")
```
